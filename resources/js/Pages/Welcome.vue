...
<template>
    ...
    <Head title="Welcome to Formula 1 Game" />

    <div
        class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-200 sm:items-center sm:pt-0">
        ...
        <section class="bg-white dark:bg-green-500 rounded-2xl">
            <div class="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
                ...
                <form :action="route('initiate-game')" class="space-y-8" method="POST">
                ...
                <ul class="grid w-full gap-6 md:grid-cols-2">
                    ...
                    <button type="submit"
                        class="text-white py-3 px-5 text-lg font-medium text-center rounded-lg bg-green-500 sm:w-fit hover:bg-green-300 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Start</button>
